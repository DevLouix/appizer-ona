...
def handle_splash_image(splash_config, android_res_path, input_assets_dir):
    """
    ...
    Args:
        ...
        input_assets_dir (str): The path where user's input assets are mounted (e.g., '/input-assets').
    """
    ...
    try:
        if splash_content.startswith("http"):
            ...
            # Assuming local path is relative to the mounted input_assets_dir
            input_path = os.path.join(input_assets_dir, splash_content)
