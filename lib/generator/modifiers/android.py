...
def inject_into_android_files(config, android_project_root, container_multi_platform_root, webapp_assets_dir):
    """
    ...
    if splash_config:
        handle_splash_image(splash_config, android_res_path, webapp_assets_dir)
    else:
